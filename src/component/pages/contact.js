            ...
            <section className="section-padding">
                        ...
                        <Row className='justify-content-center'>
                            <Col lg={3} className="mb-3">
                                <div className='service-card'>
                                    ...
                                    <p className='text-center'>(+91)1234567890<br />(+81)1234567890</p>
                                </div>
                            </Col>
                            <Col lg={3} className="mb-3">
                                <div className='service-card'>
                                    ...
                                    <p className='text-center'>info@canine.com<br />hr@canine.com</p>
                                </div>
                            </Col>
                            <Col lg={3} className="mb-3">
                                <div className='service-card'>
                                    ...
                                    <p className='text-center'>Canine Products<br />Borvali(Mumbai)</p>
                                </div>
                            </Col>
                            <Col lg={3} className="mb-3">
                                <div className='service-card'>
                                    ...
                                    <h2 className='text-center'>Open Hours</h2>
                                    <p className='text-center'>Mon-Fri:7am-6pm<br />Sat-Sun:9ap-4pm</p>
                                </div>
                            </Col>
                ...
                <Container>
                    <div className='text-left'>
                        ...
                        <p>Massa enim nec dui nunc mattis enim ut tellus. Auctor augue mauris <br/>augue neque gravida in fermentum</p>
                    </div>
                    <Row>
                        <Col lg={6}>
                            <Row>
